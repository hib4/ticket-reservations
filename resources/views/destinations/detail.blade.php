    ...
    <div class="col-lg-12">
        <form>
            <div class="text-center">
                <img class="rounded-1" src="https://source.unsplash.com/800x400?destinations">
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="name" class="form-control" placeholder="Enter Description" name="description" required
                    disabled value="{{ $destination->description }}">
            </div>
            <div class="form-group mb-3">
            ...
            <a class="btn btn-danger mb-3" href="/destinations/all">Back</a>
        </form>
    </div>
@endsection
